...
let Raumtemperatur: PageThermo = 
{
    ...
    "subPage": false,
    "parent":undefined,
    "items": [<PageItem>{ id: "alias.0.Ankleide.Raumtemperatur" , minValue: 170, maxValue: 250}]
}; 
...
let NSPanel_Infos: PageEntities =
{
    ...
    "parent": Service,
    "items": [
        <PageItem>{ id: "alias.0.NSPanel_OG.Hardware", name: "Hardware", icon: "memory", offColor: MSYellow, onColor: MSYellow, useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_OG.Temperature", name: "ESP Temperatur", icon: "thermometer", unit: "°C", offColor: MSYellow, onColor: MSYellow, useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_OG.IP", name: "IP", icon: "ip-network", offColor: MSYellow, onColor: MSYellow, useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_OG.RSSI", name: "Wifi-Signal", icon: "signal-distance-variant", unit: "dBm", offColor: MSYellow, onColor: MSYellow, useColor: true}
    ]
};
...
let NSPanel_Einstellungen: PageEntities =
{
    ...
    "parent": Service,
    "items": [
        <PageItem>{ id: "alias.0.NSPanel_OG.BrightnessDay", name: "Brightness Tag", icon: "brightness-5", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 10, maxValue: 15},
        <PageItem>{ id: "alias.0.NSPanel_OG.BrightnessNight", name: "Brightness Nacht", icon: "brightness-4", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 0, maxValue: 4},
        <PageItem>{ id: "alias.0.NSPanel_OG.HourDay", name: "Stunde Tag", icon: "sun-clock", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 5, maxValue: 9},
        <PageItem>{ id: "alias.0.NSPanel_OG.HourNight", name: "Stunde Nacht", icon: "sun-clock-outline", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 18, maxValue: 23}
    ]
};
...
let NSPanel_Firmware_Updates: PageEntities =
{
    ...
    "parent": Service,
    "items": [
        <PageItem>{ id: "alias.0.NSPanel_OG.NSPanelAutoUpdate", name: "Auto-Updates" ,icon: "update", offColor: MSRed, onColor: MSGreen},
        <PageItem>{ id: "alias.0.NSPanel_OG.TasmotaVersion", name: "Firmware", useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_OG.TasmotaOnlineVersion", name: "Firmware online", useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_OG.Version", name: "TFT-Firmware", useColor: true},
    ]
};																																											
...
export const config: Config = {
    panelRecvTopic: 'mqtt.0.NSPanelOG.tele.RESULT',       // anpassen
    panelSendTopic: 'mqtt.0.NSPanelOG.cmnd.CustomSend',   // anpassen
   ...
   mrIcon1ScreensaverEntity: { ScreensaverEntity: 'mqtt.0.NSPanelOG.stat.POWER1', ScreensaverEntityIcon: 'heating-coil', ScreensaverEntityOnColor: On, ScreensaverEntityOffColor: Black  },
    mrIcon2ScreensaverEntity: { ScreensaverEntity: 'shelly.1.shellyplus1pm#7c87ce6548c4#1.Relay0.Switch', ScreensaverEntityIcon: 'heating-coil', ScreensaverEntityOnColor: Black, ScreensaverEntityOffColor: Black  },
    ...
    button2Page: Raumtemperatur    //Beispiel-Seite auf Button 2, wenn Rule2 definiert - Wenn nicht definiert --> button1Page: null,
};
