...
var NSPanel_Infos: PageEntities =
{
    ...
    "parent": Service,
    "items": [
        <PageItem>{ id: "alias.0.NSPanel_1.Hardware", name: "Hardware", icon: "memory", offColor: MSYellow, onColor: MSYellow, useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_1.Temperature", name: "ESP Temperatur", icon: "thermometer", unit: "°C", offColor: MSYellow, onColor: MSYellow, useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_1.IP", name: "IP", icon: "ip-network", offColor: MSYellow, onColor: MSYellow, useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_1.RSSI", name: "Wifi-Signal", icon: "signal-distance-variant", unit: "dBm", offColor: MSYellow, onColor: MSYellow, useColor: true}
    ]
};
...
var NSPanel_Einstellungen: PageEntities =
{
    ...
    "parent": Service,
    "items": [
        <PageItem>{ id: "alias.0.NSPanel_1.BrightnessDay", name: "Brightness Tag", icon: "brightness-5", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 10, maxValue: 15},
        <PageItem>{ id: "alias.0.NSPanel_1.BrightnessNight", name: "Brightness Nacht", icon: "brightness-4", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 0, maxValue: 4},
        <PageItem>{ id: "alias.0.NSPanel_1.HourDay", name: "Stunde Tag", icon: "sun-clock", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 5, maxValue: 9},
        <PageItem>{ id: "alias.0.NSPanel_1.HourNight", name: "Stunde Nacht", icon: "sun-clock-outline", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 18, maxValue: 23}
    ]
};
...
var NSPanel_Firmware_Updates: PageEntities =
{
    ...
    "parent": Service,
    "items": [
        <PageItem>{ id: "alias.0.NSPanel_1.NSPanelAutoUpdate", name: "Auto-Updates" ,icon: "update", offColor: MSRed, onColor: MSGreen},
        <PageItem>{ id: "alias.0.NSPanel_1.TasmotaVersion", name: "Firmware", useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_1.TasmotaOnlineVersion", name: "Firmware online", useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_1.Version", name: "TFT-Firmware", useColor: true},
    ]
};
...
export const config: Config = {
    ...
    mrIcon1ScreensaverEntity: { ScreensaverEntity: 'mqtt.0.NSPanel.stat.POWER1', ScreensaverEntityIcon: 'heating-coil', ScreensaverEntityOnColor: On, ScreensaverEntityOffColor: Black  },
