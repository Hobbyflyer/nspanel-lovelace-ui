...
icons : https://docs.nspanel.pky.eu/icon-cheatsheet.html														
...
let Light_Wohnen: PageGrid=
{
    ...
    "parent":undefined,
    "items":[
        <PageItem>{ id: "alias.0.Licht.Wohn/Essen.Wand_links", name: "Wand links", interpolateColor: false},
        <PageItem>{ id: "alias.0.Licht.Wohn/Essen.Wand_mitte", name: "Wand mitte", minValueBrightness: 0, maxValueBrightness: 100, interpolateColor: false},
        <PageItem>{ id: "alias.0.Licht.Wohn/Essen.Wand_rechts", name: "Wand rechts", minValueBrightness: 0, maxValueBrightness: 100, interpolateColor: false},
        <PageItem>{ id: "alias.0.Licht.Wohn/Essen.TV", name: "TV", minValueBrightness: 0, maxValueBrightness: 100, interpolateColor: false},
        <PageItem>{ id: "alias.0.Wohnzimmer.Fernseher", name: "Fernseher", icon: "television-box", offColor: MSRed, onColor: MSGreen},
        <PageItem>{ id: "alias.0.Licht.Wohn/Essen.Gruppe_Wand", name: "Licht", icon:"lightbulb-group", minValueColorTemp:2700, maxValueColorTemp: 6500,minValueBrightness: 0, maxValueBrightness: 100, interpolateColor: true}
    ]
};

let Light_Essen: PageGrid=
{
    "type":"cardGrid",
    "heading": "Essen",
    "useColor": true,
    ...
    "parent":undefined,
    "items":[
        <PageItem>{ id: "alias.0.Licht.Wohn/Essen.Esstisch", name: "Esstisch",icon: "lightbulb-multiple", minValueBrightness: 0, maxValueBrightness: 100, interpolateColor: false},
        <PageItem>{ id: "alias.0.Licht.Wohn/Essen.Schrank_links", name: "Schrank links", minValueBrightness: 0, maxValueBrightness: 100, minValueColorTemp: 2700, maxValueColorTemp: 6400, interpolateColor: true},
        <PageItem>{ id: "alias.0.Licht.Wohn/Essen.Schrank_mitte", name: "Schrank mitte", minValueBrightness: 0, maxValueBrightness: 100, minValueColorTemp: 2700, maxValueColorTemp: 6400, interpolateColor: true},
        <PageItem>{ id: "alias.0.Licht.Küche/Essen.Sockelleiste", name: "Küche", interpolateColor: true}
    ]
};
...
let Szenen: PageGrid=
{
    ...
    "parent":undefined,
    "items":[
        <PageItem>{ id: "alias.0.Wohnzimmer.Filmzeit", name: "Filmzeit", icon: "movie-open", offColor: MSRed, onColor: MSGreen},
        <PageItem>{ id: "alias.0.Licht.Wohn/Essen.Szene_Essen", name: "Essen", icon: "silverware-variant", offColor: MSRed, onColor: MSGreen},
        <PageItem>{ id: "alias.0.Licht.Wohn/Essen.Szene_Spielen", name: "Spielen", icon: "movie-open", offColor: MSRed, onColor: MSGreen},
        <PageItem>{ id: "alias.0.Licht", name: "Spielen", icon: "movie-open", offColor: MSRed, onColor: MSGreen},
        <PageItem>{ id: "alias.0.Licht", name: "Spielen", icon: "movie-open", offColor: MSRed, onColor: MSGreen},
        <PageItem>{ id: "alias.0.Wohnzimmer.GuteNacht", name: "Gute Nacht", icon: "sleep", offColor: MSRed, onColor: MSGreen}
    ]
};

let Media: PageEntities =
{
    "type": "cardEntities",
    "heading": "Media",
    "useColor": true,
    ...
    "items": [
        ...
        <PageItem>{ navigate: true, id: "AlexaStudio", icon: "information-outline", onColor: White, name: "Echo Studio"},
        <PageItem>{ navigate: true, id: "AlexaShow", icon: "information-outline", onColor: White, name: "Echo Show"},
    ]
};

let AlexaStudio: PageMedia = 
{
    "type": "cardMedia",
    "heading": "Alexa Studio",
    "useColor": true,
    "subPage": true,
    "parent": Media,
    "items": [<PageItem>{   
                id: "alias.0.NSPanel_WZ.Media.PlayerAlexa2", 
                adapterPlayerInstance: "alexa2.0.",
                mediaDevice: "G2A0XL07019305UK", 
                speakerList: ['Echo Studio','Echo Show','Erdgeschoss']
             }]
};

let AlexaShow: PageMedia = 
{
    "type": "cardMedia",
    "heading": "Alexa Show",
    "useColor": true,
    ...
    "parent": Media,
    "items": [<PageItem>{   
                id: "alias.0.NSPanel_WZ.Media.PlayerAlexaShow", 
                adapterPlayerInstance: "alexa2.0.",
                mediaDevice: "G2A0XL07019305UK", 
                speakerList: ['Echo Studio','Echo Show','Erdgeschoss'],
...
let Raumtemperatur: PageThermo = 
{
    "type": "cardThermo",
    "heading": "Raumtemperatur",
    "useColor": true,
    "subPage": false,
    "parent":undefined,
    "items": [<PageItem>{ id: "alias.0.Wohnzimmer.Raumtemperatur", minValue: 170, maxValue: 250}]
}; 
...
let Power: PagePower =
{
    ...
    "parent": undefined,
    "items": [
        <PageItem>{ id: "alias.0.NSPanel_WZ.CardPower" },
    ]
};
...
let NSPanel_Infos: PageEntities =
{
    ...
    "parent": Service,
    "items": [
        <PageItem>{ id: "alias.0.NSPanel_WZ.Hardware", name: "Hardware", icon: "memory", offColor: MSYellow, onColor: MSYellow, useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_WZ.Temperature", name: "ESP Temperatur", icon: "thermometer", unit: "°C", offColor: MSYellow, onColor: MSYellow, useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_WZ.IP", name: "IP", icon: "ip-network", offColor: MSYellow, onColor: MSYellow, useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_WZ.RSSI", name: "Wifi-Signal", icon: "signal-distance-variant", unit: "dBm", offColor: MSYellow, onColor: MSYellow, useColor: true}
    ]
};
...
let NSPanel_Einstellungen: PageEntities =
{
    ...
    "parent": Service,
    "items": [
        <PageItem>{ id: "alias.0.NSPanel_WZ.BrightnessDay", name: "Brightness Tag", icon: "brightness-5", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 10, maxValue: 15},
        <PageItem>{ id: "alias.0.NSPanel_WZ.BrightnessNight", name: "Brightness Nacht", icon: "brightness-4", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 0, maxValue: 4},
        <PageItem>{ id: "alias.0.NSPanel_WZ.HourDay", name: "Stunde Tag", icon: "sun-clock", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 5, maxValue: 9},
        <PageItem>{ id: "alias.0.NSPanel_WZ.HourNight", name: "Stunde Nacht", icon: "sun-clock-outline", offColor: MSYellow, onColor: MSYellow, useColor: true, minValue: 18, maxValue: 23}
    ]
};
...
let NSPanel_Firmware_Updates: PageEntities =
{
    ...
    "parent": Service,
    "items": [
        <PageItem>{ id: "alias.0.NSPanel_WZ.NSPanelAutoUpdate", name: "Auto-Updates" ,icon: "update", offColor: MSRed, onColor: MSGreen},
        <PageItem>{ id: "alias.0.NSPanel_WZ.TasmotaVersion", name: "Firmware", useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_WZ.TasmotaOnlineVersion", name: "Firmware online", useColor: true},
        <PageItem>{ id: "alias.0.NSPanel_WZ.Version", name: "TFT-Firmware", useColor: true},
    ]
};


export const config: Config = {
    panelRecvTopic: 'mqtt.0.NSPanelWZ.tele.RESULT',       // anpassen
    panelSendTopic: 'mqtt.0.NSPanelWZ.cmnd.CustomSend',   // anpassen
    firstScreensaverEntity: { ScreensaverEntity: "weatherunderground.0.forecast.current.relativeHumidity", ScreensaverEntityIcon: "water-percent", ScreensaverEntityText: "Luft", ScreensaverEntityUnitText: "%", ScreensaverEntityIconColor: {'val_min': 0, 'val_max': 100, 'val_best': 65} },
    secondScreensaverEntity: { ScreensaverEntity: "weatherunderground.0.forecast.current.wind", ScreensaverEntityIcon: "weather-windy", ScreensaverEntityText: "Wind", ScreensaverEntityUnitText: "km/h", ScreensaverEntityIconColor: {'val_min': 0, 'val_max': 180} },
    thirdScreensaverEntity: { ScreensaverEntity: "senec.0.ENERGY.GUI_BAT_DATA_FUEL_CHARGE", ScreensaverEntityIcon: "battery-charging", ScreensaverEntityText: "BAT", ScreensaverEntityUnitText: "%", ScreensaverEntityIconColor: {'val_best':100, 'val_min': 0, 'val_max': 100} },
    fourthScreensaverEntity: { ScreensaverEntity: "senec.0.ENERGY.GUI_GRID_POW", ScreensaverEntityIcon: "transmission-tower", ScreensaverEntityText: "Netz", ScreensaverEntityUnitText: "W", ScreensaverEntityIconColor: {'val_best':0, 'val_min': -5200, 'val_max': 6000} },
    alternativeScreensaverLayout: false,
    autoWeatherColorScreensaverLayout: true,
    mrIcon1ScreensaverEntity: { ScreensaverEntity: 'mqtt.0.NSPanelWZ.stat.POWER1', ScreensaverEntityIcon: 'heating-coil', ScreensaverEntityOnColor: On, ScreensaverEntityOffColor: HMIDark  },
    mrIcon2ScreensaverEntity: { ScreensaverEntity: 'shelly.1.shellyplus1pm#7c87ce6548c4#1.Relay0.Switch', ScreensaverEntityIcon: 'heat-wave', ScreensaverEntityOnColor: On, ScreensaverEntityOffColor: HMIDark  },
    ...
    weatherEntity: 'alias.0.Wetter-Moorenweis',    // Dieser Alias muss erstellt werden, damit die 4 kleineren Icons (Wetter oder DP) angezeigt werden können
    defaultOffColor: Off,
    defaultOnColor: On,
    defaultColor: Off,
    ...
    button1Page: Light_Wohnen,   //Beispiel-Seite auf Button 1, wenn Rule2 definiert - Wenn nicht definiert --> button1Page: null, 
    button2Page: Szenen          //Beispiel-Seite auf Button 2, wenn Rule2 definiert - Wenn nicht definiert --> button1Page: null,
};
...
function GeneratePage(page: Page): void {
    try {
        activePage = page;
        setState(NSPanel_Path + 'ActivePage',page.heading);
        switch (page.type) {
            case 'cardEntities':
...
function HandleScreensaver(): void {
    ...
    setState(NSPanel_Path + 'ActivePage',"Screensaver");
    UnsubscribeWatcher();
    HandleScreensaverUpdate();
