...
/*var CardPower: PagePower =
{
    ...
    "parent": undefined,
    "items": [
        <PageItem>{ id: "alias.0.NSPanel_WZ.Power.PowerCard" },
    ]
};*/
...
export const config: Config = {
    ...
    weatherEntity: 'alias.0.Wetter.Moorenweis',
    defaultOffColor: Off,
    defaultOnColor: On,
    defaultColor: Off,
    temperatureUnit: '°C',
                ...
                if (o.common.role == 'ct') {
                    ...
                    out_msgs.push({
                        payload: 'entityUpdateDetail' + '~'                   //entityUpdateDetail
                            ...
                            + brightness + '~'                   //sliderBrightnessPos
                            + colorTemp + '~'                   //sliderColorTempPos
                            + 'disable' + '~'                   //colorMode   (if hue-alias without hue-datapoint, then disable)
                            + 'Color' + '~'         //Color-Bezeichnung
                            + findLocale('lights', 'Temperature') + '~'   //Temperature-Bezeichnung
                            + findLocale('lights', 'Brightness')
                    });       //Brightness-Bezeichnung
